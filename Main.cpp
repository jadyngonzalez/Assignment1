  ...
  if(argc > 2)
  {
  ...
  else if(argc == 2)
    {
      ...
      while(true)
      {
        ...
        JadynGonzalez.open("JadynGonzalez.out", ofstream::app);
        ...
        double Aprob = (double(A)/totalNuc);
        double Tprob = (double(T)/totalNuc);
        double Cprob = (double(C)/totalNuc);
        double Gprob = (double(G)/totalNuc);
